...
export class SwipeLayoutBase extends ContentView {
  ...
  private swipeGestureHandler(
    swipeGestureEventDataValue: SwipeGestureEventData
  ) {
  ...
  private dismissPaning(panGestureEventDataValue: PanGestureEventData) {
    ...
    let directionBuilder: PanDirectionBuilder = new PanDirectionBuilder(
      this.initDelta,
      currentLocation,
      this.effectiveWidth,
  ...
  private getEventData(direction: SwipeDirection): SwipeEventData {
    ...
    switch (direction) {
      case SwipeDirection.down:
        shouldBeAnimated =
          (this.animationState === ANIMATION_STATE.ON_EVENTS &&
            this.hasSwipeDownListener()) ||
          this.animationState === ANIMATION_STATE.ALWAYS;
        eventData = new SwipeDownEventData(
          this.originX,
          this.originY,
          this.initOriginX,
          height + height / 2,
      ...
      case SwipeDirection.up:
        shouldBeAnimated =
          (this.animationState === ANIMATION_STATE.ON_EVENTS &&
            this.hasSwipeUpListener()) ||
          this.animationState === ANIMATION_STATE.ALWAYS;
        eventData = new SwipeUpEventData(
          this.originX,
          this.originY,
          this.initOriginX,
          -height / 2,
      ...
      case SwipeDirection.left:
        shouldBeAnimated =
          (this.animationState === ANIMATION_STATE.ON_EVENTS &&
            this.hasSwipeLeftListener()) ||
          this.animationState === ANIMATION_STATE.ALWAYS;
        eventData = new SwipeLeftEventData(
          this.originX,
          this.originY,
          -width / 2,
          this.initOriginY,
      ...
      case SwipeDirection.right:
        shouldBeAnimated =
          (this.animationState === ANIMATION_STATE.ON_EVENTS &&
            this.hasSwipeRightListener()) ||
          this.animationState === ANIMATION_STATE.ALWAYS;
        eventData = new SwipeRightEventData(
          this.originX,
          this.originY,
          width + width / 2,
          this.initOriginY,
...
export const animationStateProperty = new Property<
  SwipeLayoutBase,
  ANIMATION_STATE
>({
  name: "animationState",
